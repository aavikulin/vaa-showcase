    ...
    projects: [
      {
        title: "basis_",
        year: "2026",
        description: "AI-система для управления строительными проектами: собирает данные из Jira, Confluence и BIM-моделей, показывает риски, связи и влияние решений.",
        role: "AI Engineer",
        period: "2026",
        detail: "basis_ помогает команде видеть состояние строительного проекта в одном месте. Система собирает задачи и документы из Jira и Confluence, связывает их с BIM-моделью, находит риски и противоречия и показывает, к чему могут привести изменения и решения.",
        impact: [
          "Связал задачи, риски, запросы на изменения, решения и их последствия в единый граф из 331 узла и 639 связей.",
          "Собрал в одном интерфейсе сводку по проекту, базу знаний, граф связей и просмотр BIM/IFC-моделей.",
          "Добавил AI-чат, который отвечает на вопросы о проекте и показывает, на каких данных основан ответ.",
          "Настроил автоматический поиск противоречий, блокеров и расхождений между Jira и Confluence.",
        ],
      ...
      },
      {
        ...
        year: "2026",
        description: "Сервис для перевода строительных чертежей в формате PDF. Сохраняет расположение элементов, графику, таблицы и технические обозначения.",
        role: "AI Engineer",
        period: "2026",
    ...
    projects: [
      {
        title: "basis_",
        year: "2026",
        description: "An AI system for construction project management that brings together data from Jira, Confluence, and BIM models to highlight risks, connections, and the impact of decisions.",
        role: "AI Engineer",
        period: "2026",
        detail: "basis_ helps teams see the state of a construction project in one place. It collects tasks and documents from Jira and Confluence, connects them to the BIM model, finds risks and inconsistencies, and shows how changes and decisions may affect the project.",
        impact: [
          "Connected tasks, risks, change requests, decisions, and their consequences in a single graph with 331 nodes and 639 links.",
          "Brought the project overview, knowledge base, relationship graph, and BIM/IFC model viewer into one interface.",
          "Added an AI chat that answers questions about the project and shows which source data supports each answer.",
          "Set up automatic detection of contradictions, blockers, and mismatches between Jira and Confluence.",
        ],
        tags: ["knowledge graph", "Atlassian", "BIM/IFC", "evidence-grounded AI", "construction tech"],
        href: BASIS_STAND_URL,
        external: true,
